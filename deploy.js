...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf deployment-handson-twotemp && mkdir deployment-handson-two-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir deployment-handson-two && cp -r deployment-handson-two-temp/* deployment-handson-two/ && rm -rf deployed-handson-temp', {
      cwd: '/home/ubuntu'
  });
}
